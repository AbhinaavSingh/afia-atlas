export const siteContent = {
  ...
  contributionIntro:
    'Share one photograph and one moment you would love Afia to carry into her next decade.',
  lockedHeading: 'Something beautiful is taking shape.',
  lockedCopy:
    'A little universe is being made for Afia’s 30th birthday. The doors open very soon.',
} as const
